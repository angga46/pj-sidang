      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="erlanggafebrian567@gmail.com">erlanggafebrian567@gmail.com</a>
          ...
          <a href="https://www.instagram.com/sputxxzz_">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://www.instagram.com/nggafbn_">angga46</a>
